...
#define ZTRAIT_BLUESPACE_EXPLORATION "Bluespace Exploration"
...
#define ZTRAITS_BLUESPACE_EXPLORATION list(ZTRAIT_LINKAGE = SELFLOOPING, ZTRAIT_BLUESPACE_EXPLORATION = TRUE)
