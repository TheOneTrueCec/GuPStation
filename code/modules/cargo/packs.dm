...
/datum/supply_pack/engine/tesla_coils
	...
	desc = "Whether it's high-voltage executions, creating research points, assistant electrofrying, or just plain old power generation: This pack of four Tesla coils can do it all!"
	cost = 2500
