...
/datum/techweb_node/basic_medical
	...
	design_ids = list("cybernetic_liver", "cybernetic_heart", "cybernetic_lungs","cybernetic_stomach", "scalpel",
					...
					"dropper", "defibmountdefault", "surgical_tape", "surgery_dissection", "portable_chem_mixer")
...
/datum/techweb_node/adv_biotech
	...
	design_ids = list("piercesyringe", "crewpinpointer", "smoke_machine", "plasmarefiller", "limbgrower", "clonecontrol", "clonepod", "meta_beaker", "healthanalyzer_advanced", "harvester", "holobarrier_med", "detective_scanner", "defibrillator_compact")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
...
/datum/techweb_node/adv_surgery
	...
	design_ids = list("surgery_lobotomy", "surgery_heal_brute_upgrade_femto", "surgery_dissection_adv", "surgery_heal_burn_upgrade_femto","surgery_heal_combo","surgery_wing_reconstruction")
...
/datum/techweb_node/exp_surgery
	...
	design_ids = list("surgery_pacify","surgery_vein_thread", "surgery_dissection_adv", "surgery_muscled_veins","surgery_nerve_splice","surgery_nerve_ground","surgery_ligament_hook","surgery_ligament_reinforcement","surgery_cortex_imprint","surgery_cortex_folding","surgery_viral_bond", "surgery_heal_combo_upgrade")
...
/datum/techweb_node/alien_surgery
	...
	design_ids = list("surgery_brainwashing","surgery_zombie", "surgery_dissection_alien","surgery_heal_combo_upgrade_femto")
...
/datum/techweb_node/advanced_bluespace
	...
	design_ids = list("bag_holding_inert", "bag_holding")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 5000)
...
/datum/techweb_node/exotic_ammo
	...
	design_ids = list("techshotshell", "c38_hotshot", "shotgundartcryostasis", "c38_iceblox")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2500)
...
/datum/techweb_node/nanite_smart
	...
	design_ids = list("purging_nanites", "metabolic_nanites", "stealth_nanites", "memleak_nanites","sensor_voice_nanites", "voice_nanites", "change_cloud_nanites")
...
/datum/techweb_node/nanite_bio
	...
	design_ids = list("regenerative_nanites", "preserving_nanites", "bloodheal_nanites", "coagulating_nanites","poison_nanites","flesheating_nanites",\
