...
/obj/machinery/computer/weapons
	...
	var/obj/screen/map_view/weapons_console/cam_screen
...
/obj/screen/map_view/weapons_console
	var/datum/weakref/linked_console

/obj/screen/map_view/weapons_console/proc/link_to_console(console)
	linked_console = WEAKREF(console)

/obj/screen/map_view/weapons_console/Click(location, control, params)
	. = ..()
